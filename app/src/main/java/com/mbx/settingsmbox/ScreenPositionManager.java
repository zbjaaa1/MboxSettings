...
//Rony add    
    private final static String sel_1024x768output_x = "ubootenv.var.1024x768_x";
    private final static String sel_1024x768output_y = "ubootenv.var.1024x768_y";
    private final static String sel_1024x768output_width = "ubootenv.var.1024x768_width";
    private final static String sel_1024x768output_height = "ubootenv.var.1024x768_height";
    private final static String sel_1280x800output_x = "ubootenv.var.1280x800_x";
    private final static String sel_1280x800output_y = "ubootenv.var.1280x800_y";
    private final static String sel_1280x800output_width = "ubootenv.var.1280x800_width";
    private final static String sel_1280x800output_height = "ubootenv.var.1280x800_height";
    private final static String sel_1600x1200output_x = "ubootenv.var.1600x1200_x";
    private final static String sel_1600x1200output_y = "ubootenv.var.1600x1200_y";
    private final static String sel_1600x1200output_width = "ubootenv.var.1600x1200_width";
    private final static String sel_1600x1200output_height = "ubootenv.var.1600x1200_height";
    private final static String sel_1920x1200output_x = "ubootenv.var.1920x1200_x";
    private final static String sel_1920x1200output_y = "ubootenv.var.1920x1200_y";
    private final static String sel_1920x1200output_width = "ubootenv.var.1920x1200_width";
    private final static String sel_1920x1200output_height = "ubootenv.var.1920x1200_height";
    private final static String sel_2560x1600output_x = "ubootenv.var.2560x1600_x";
    private final static String sel_2560x1600output_y = "ubootenv.var.2560x1600_y";
    private final static String sel_2560x1600output_width = "ubootenv.var.2560x1600_width";
    private final static String sel_2560x1600output_height = "ubootenv.var.2560x1600_height";
...
//Rony add    
    private static final int OUTPUT1024x768_FULL_WIDTH = 1024;
    private static final int OUTPUT1024x768_FULL_HEIGHT = 768;
    private static final int OUTPUT1280x800_FULL_WIDTH = 1280;
    private static final int OUTPUT1280x800_FULL_HEIGHT = 800;
    private static final int OUTPUT1600x1200_FULL_WIDTH = 1600;
    private static final int OUTPUT1600x1200_FULL_HEIGHT = 1200;
    private static final int OUTPUT1920x1200_FULL_WIDTH = 1920;
    private static final int OUTPUT1920x1200_FULL_HEIGHT = 1200;
    private static final int OUTPUT2560x1600_FULL_WIDTH = 2560;
    private static final int OUTPUT2560x1600_FULL_HEIGHT = 1600;
	...
	private static final String[] outputmode_array = {"480i","480p","576i","576p","720p","1080i","1080p","720p50hz","1080i50hz","1080p50hz" , "480cvbs","576cvbs","4k2k24hz","4k2k25hz", "4k2k30hz", "4k2ksmpte","1080p24hz", "1024x768p60hz", "1280x800p60hz", "1600x1200p60hz", "1920x1200p60hz", "2560x1600p60hz"};
...
//Rony add            
        }else if (mCurrentMode.equals("1024x768p60hz")){
            mPreLeft = sw.getPropertyInt(sel_1024x768output_x,0);
            mPreTop = sw.getPropertyInt(sel_1024x768output_y,0);
            mPreWidth = sw.getPropertyInt(sel_1024x768output_width,OUTPUT1024x768_FULL_WIDTH);
            mPreHeight = sw.getPropertyInt(sel_1024x768output_height,OUTPUT1024x768_FULL_HEIGHT);
        }else if (mCurrentMode.equals("1280x800p60hz")){
            mPreLeft = sw.getPropertyInt(sel_1280x800output_x,0);
            mPreTop = sw.getPropertyInt(sel_1280x800output_y,0);
            mPreWidth = sw.getPropertyInt(sel_1280x800output_width,OUTPUT1280x800_FULL_WIDTH);
            mPreHeight = sw.getPropertyInt(sel_1280x800output_height,OUTPUT1280x800_FULL_HEIGHT);
        }else if (mCurrentMode.equals("1600x1200p60hz")){
            mPreLeft = sw.getPropertyInt(sel_1600x1200output_x,0);
            mPreTop = sw.getPropertyInt(sel_1600x1200output_y,0);
            mPreWidth = sw.getPropertyInt(sel_1600x1200output_width,OUTPUT1600x1200_FULL_WIDTH);
            mPreHeight = sw.getPropertyInt(sel_1600x1200output_height,OUTPUT1600x1200_FULL_HEIGHT);
        }else if (mCurrentMode.equals("1920x1200p60hz")){
            mPreLeft = sw.getPropertyInt(sel_1920x1200output_x,0);
            mPreTop = sw.getPropertyInt(sel_1920x1200output_y,0);
            mPreWidth = sw.getPropertyInt(sel_1920x1200output_width,OUTPUT1920x1200_FULL_WIDTH);
            mPreHeight = sw.getPropertyInt(sel_1920x1200output_height,OUTPUT1920x1200_FULL_HEIGHT);
        }else if (mCurrentMode.equals("2560x1600p60hz")){
            mPreLeft = sw.getPropertyInt(sel_2560x1600output_x,0);
            mPreTop = sw.getPropertyInt(sel_2560x1600output_y,0);
            mPreWidth = sw.getPropertyInt(sel_2560x1600output_width,OUTPUT2560x1600_FULL_WIDTH);
            mPreHeight = sw.getPropertyInt(sel_2560x1600output_height,OUTPUT2560x1600_FULL_HEIGHT);
        }
...
//Rony add            
        }else  if(mode.contains("1024x768")){
	     mMaxRight = 1023;
	     mMaxBottom = 767;
        }else  if(mode.contains("1280x800")){
	     mMaxRight = 1279;
	     mMaxBottom = 799;
        }else  if(mode.contains("1600x1200")){
	     mMaxRight = 1599;
	     mMaxBottom = 1199;
        }else  if(mode.contains("1920x1200")){
	     mMaxRight = 1919;
	     mMaxBottom = 1199;
        }else  if(mode.contains("2560x1600")){
	     mMaxRight = 2559;
	     mMaxBottom = 1599;
        }else{
            mMaxRight = 1919;
		...
		switch (index) {
            ...
            case 14:    //4k2k30hz
             ...
             case 15:    //4k2ksmpte
    			...
    			break;
//Rony add 	
			case 17: // 1024x768p60hz
			    sw.setProperty(sel_1024x768output_x, x);
			    sw.setProperty(sel_1024x768output_y, y);
			    sw.setProperty(sel_1024x768output_width, w);
			    sw.setProperty(sel_1024x768output_height, h);
			    break;
			case 18: // 1280x800p60hz
			    sw.setProperty(sel_1280x800output_x, x);
			    sw.setProperty(sel_1280x800output_y, y);
			    sw.setProperty(sel_1280x800output_width, w);
			    sw.setProperty(sel_1280x800output_height, h);
			    break;
			case 19: // 1600x1200p60hz
			    sw.setProperty(sel_1600x1200output_x, x);
			    sw.setProperty(sel_1600x1200output_y, y);
			    sw.setProperty(sel_1600x1200output_width, w);
			    sw.setProperty(sel_1600x1200output_height, h);
			    break;
			case 20: // 1920x1200p60hz
			    sw.setProperty(sel_1920x1200output_x, x);
			    sw.setProperty(sel_1920x1200output_y, y);
			    sw.setProperty(sel_1920x1200output_width, w);
			    sw.setProperty(sel_1920x1200output_height, h);
			    break;
			case 21: // 2560x1600p60hz
			    sw.setProperty(sel_2560x1600output_x, x);
			    sw.setProperty(sel_2560x1600output_y, y);
			    sw.setProperty(sel_2560x1600output_width, w);
			    sw.setProperty(sel_2560x1600output_height, h);
			    break;
