...
public class AccessPointListAdapter extends BaseAdapter {
	...
	public void connect2AccessPoint(ScanResult selectAccessPoint, String password) {
		ScanResult currentAccessPoint;
		if (selectAccessPoint != null) {
			currentAccessPoint = selectAccessPoint;
		} else {
			currentAccessPoint = mScanResultList.get(currentSelectIndex);
		}
