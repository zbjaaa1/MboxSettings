...
//modifed by clei for show kernel version
            "(.*+)"; 
            //"(#\\d+) " +              /* group 3: "#1" */
...
//modifed by clei for show kernel version
        ...
        if (!m.matches()) {
            ...
            return "Unavailable";
        } else if (m.groupCount() < 3) {//modifed by clei for show kernel version
            Log.e(TAG, "Regex match on /proc/version only returned " + m.groupCount()
                    + " groups");
            return "Unavailable";
        }
        return m.group(1) + "\n" +                 // 3.0.31-g6fb96c9
            m.group(2) + " " + m.group(3)/* + "\n" + // x@y.com #1 modifed by clei for show kernel version
